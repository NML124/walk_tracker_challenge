...
class AppColors {
  ...
  static const Color lightSleep = Color(0xFF03A9F4);

  static const Color lightCardBackground = Color(0xFFFFFFFF);
  static const Color lightCardTitle = Color(0xFF333333);
  static const Color lightAccent = Color(0xFFEF5350);

  static const Color lightNavInactive = Color(0xFFBDBDBD);
  ...
  static const Color darkNavActive = Color(0xFF7986CB);
}
